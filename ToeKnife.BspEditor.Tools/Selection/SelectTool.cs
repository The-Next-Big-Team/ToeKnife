...
using ToeKnife.BspEditor.Tools.Selection.TransformationHandles;
using ToeKnife.BspEditor.Tools.Widgets;
...
namespace ToeKnife.BspEditor.Tools.Selection
{
    ...
    public class SelectTool : BaseDraggableTool, ISettingsContainer
    {
        ...
        string ISettingsContainer.Name => "ToeKnife.BspEditor.Tools.SelectTool";
