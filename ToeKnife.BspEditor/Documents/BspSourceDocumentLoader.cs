...
using ToeKnife.BspEditor.Environment.Controls;
using ToeKnife.BspEditor.Environment.Empty;
using ToeKnife.BspEditor.Primitives;
using ToeKnife.BspEditor.Providers;
using ToeKnife.BspEditor.Providers.Processors;
...
namespace ToeKnife.BspEditor.Documents
{
    /// <summary>
