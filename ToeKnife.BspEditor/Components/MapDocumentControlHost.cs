...
using ToeKnife.BspEditor.Controls;
using ToeKnife.BspEditor.Controls.Layout;
...
namespace ToeKnife.BspEditor.Components
{
    ...
    public class MapDocumentControlHost : UserControl, ISettingsContainer, IUIShutdownHook, IUIStartupHook
    {
        ...
        string ISettingsContainer.Name => "ToeKnife.BspEditor.Components.MapDocumentControlHost";
        ...
        private class HostedControl
        {
            ...
            public static List<HostedControl> Default(int windowId)
            {
                return new List<HostedControl>
                {
                    ...
                    new HostedControl { WindowID = windowId, Row = 0, Column = 1, Type = "MapViewport", Serialised = "OrthographicCamera/Side" },
                    new HostedControl { WindowID = windowId, Row = 1, Column = 0, Type = "MapViewport", Serialised = "OrthographicCamera/Front" },
                    new HostedControl { WindowID = windowId, Row = 1, Column = 1, Type = "MapViewport", Serialised = "OrthographicCamera/Top" },
                };
            }
        }
    }
