...
using Plane = ToeKnife.DataStructures.Geometric.Precision.Plane;
using Polygon = ToeKnife.DataStructures.Geometric.Precision.Polygon;
using Polyhedron = ToeKnife.DataStructures.Geometric.Precision.Polyhedron;
using PVector3 = ToeKnife.DataStructures.Geometric.Precision.Vector3;

namespace ToeKnife.BspEditor.Providers
{
    ...
    public class VmfBspSourceProvider : IBspSourceProvider
    {
        ...
        {
            new FileExtensionInfo("Valve map format", ".vmf"), 
        };
