...
namespace ToeKnife.BspEditor.Rendering
{
    /// <summary>
    ...
    public class Renderer : ISettingsContainer
    {
        ...
        [Setting] public static Color AxisGridLineColour { get; set; } = Color.FromArgb(255, 0, 255);
        [Setting] public static Color BoundaryGridLineColour { get; set; } = Color.Red;

        // Settings container

        public string Name => "ToeKnife.BspEditor.Rendering.Renderer";
