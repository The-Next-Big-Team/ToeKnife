...
namespace ToeKnife.Editor.Update
{
    ...
    [CommandID("ToeKnife:Editor:CheckForUpdates")]
    public class CheckForUpdates : ICommand
    {
        ...
        public string NoUpdatesMessage { get; set; } = "This version of ToeKnife is currently up-to-date.";
        ...
        private async Task<UpdateReleaseDetails> GetLatestReleaseDetails()
        {
            ...
            {
                wc.Headers.Add(HttpRequestHeader.UserAgent, "LogicAndTrick/ToeKnife-Editor");
