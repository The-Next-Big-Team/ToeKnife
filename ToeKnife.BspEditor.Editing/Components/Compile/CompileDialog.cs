...
using ToeKnife.QuickForms;
using ToeKnife.Shell;

namespace ToeKnife.BspEditor.Editing.Components.Compile
{
    public sealed partial class CompileDialog : Form, IManualTranslate
    {
        ...
        public CompileDialog(CompileSpecification specification, BuildProfileRegister buildProfileRegister)
        {
            ...
            var translate = ToeKnife.Common.Container.Get<ITranslationStringProvider>();
